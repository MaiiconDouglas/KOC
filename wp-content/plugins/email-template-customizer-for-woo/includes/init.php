		...
		self::$img_map = apply_filters( 'viwec_image_map', [
			...
			'social_icons' => [
				'facebook'  => [
					...
					'fb-white-blue'   => esc_html__( 'Color - White', 'viwec-email-template-customizer' ),
				],
				'twitter'   => [
					...
					'twi-white-cyan'   => esc_html__( 'Color - White', 'viwec-email-template-customizer' ),
				],
				'instagram' => [
					...
					'ins-white-color'  => esc_html__( 'Color - White', 'viwec-email-template-customizer' ),
				]
			]
		] );
			...
			case 'viwec_template':
				...
				foreach ( self::$img_map['social_icons'] as $type => $data ) {
					foreach ( $data as $key => $text ) {
						$params['social_icons'][ $type ][] = [ 'id' => VIWEC_IMAGES . $key . '.png', 'text' => $text, 'slug' => $key ];
					}
				}
