...
class Email_Builder {
	...
	public function add_meta_boxes() {
		add_meta_box(
			'viwec-email-builder',
			esc_html__( 'Email', 'viwec-email-template-customizer' ),
		...
		add_meta_box(
			'viwec-email-type',
			esc_html__( 'Email type', 'viwec-email-template-customizer' ),
		...
		add_meta_box(
			'viwec-email-rules',
			esc_html__( 'Rules', 'viwec-email-template-customizer' ),
		...
		add_meta_box(
			'viwec-email-testing',
			esc_html__( 'Testing', 'viwec-email-template-customizer' ),
		...
		add_meta_box(
			...
			esc_html__( "Admin's note for this template", 'viwec-email-customizer' ),
		...
		add_meta_box(
			'viwec-email-data',
			esc_html__( 'Data', 'viwec-email-template-customizer' ),
	...
	public function add_edit_buttons( $email ) {
		...
		echo sprintf( "<td><a href='%1s' class='button alignright'>%2s</a></td>", esc_url( $href ), esc_html__( 'Edit with WC Email Template Customizer', 'viwec-email-template-customizer' ) );
	}
