...
<div class="mp-panel-checkout">
  <div class="mp-row-checkout">
    ...
    <div id="framePayments" class="mp-col-md-12">
        <div class="frame-tarjetas">
            <p class="mp-subtitle-basic-checkout">
                <?= __('Cartões de crédito', 'woocommerce-mercadopago') ?>
    ...
    <div id="framePayments" class="mp-col-md-6 mp-pr-15">
        <div class="frame-tarjetas">
            <p class="submp-title-checkout"><?=__('Cartão de débito', 'woocommerce-mercadopago')?></p>
    ...
    <div id="framePayments" class="mp-col-md-6">
        <div class="frame-tarjetas">
            <p class="submp-title-checkout"><?=__('Pagamentos em dinheiro', 'woocommerce-mercadopago')?></p>
