	...
	<div class="mp-row-checkout">
		...
		<div class="mp-frame-links">
			<a class="mp-checkout-link mp-pr-10" id="button-show-payments">
				<?= __('Com quais cartões posso pagar', 'woocommerce-mercadopago') ?> ⌵
			</a>
			<?php if ($site_id == 'MLA') : ?>
				...
				<a href="https://www.mercadopago.com.ar/cuotas" id="mp_checkout_link" class="mp-checkout-link mp-pl-10" target="_blank">
					<?= __('Veja as promoções atuais', 'woocommerce-mercadopago') ?>
				</a>
			<?php endif; ?>
		</div>
			...
			<div class="mp-col-md-12">
				<div class="frame-tarjetas">
					<?php if (count($credit_card) != 0) : ?>
						<p class="submp-title-checkout-custom"><?= __('Cartões de crédito', 'woocommerce-mercadopago') ?></p>
					...
					<?php if (count($debit_card) != 0) : ?>
						<p class="submp-title-checkout-custom mp-pt-10"><?= __('Cartão de débito', 'woocommerce-mercadopago') ?></p>
		...
		<?php if ($coupon_mode == 'yes') : ?>
			<div class="mp-col-md-12" id="mercadopago-form-coupon">
				<div class="frame-tarjetas mp-text-justify">
					<p class="mp-subtitle-custom-checkout"><?= __('Insira seu cupom de desconto', 'woocommerce-mercadopago') ?></p>
					...
					<div class="mp-row-checkout mp-pt-10">
						...
						<span class="mp-error" id="mpCouponError"><?= __('O código que você digitou está incorreto', 'woocommerce-mercadopago') ?></span>
					</div>
				</div>
			</div>
		<?php endif; ?>
			...
			<div class="frame-tarjetas">
				...
				<div id="mercadopago-form">
					...
					<div class="mp-col-md-12">
						<div class="frame-tarjetas">
							<!-- Title installments -->
							<p class="mp-subtitle-custom-checkout"><?= __('Em quantas prestações quer pagar', 'woocommerce-mercadopago') ?></p>
							...
							<div class="mp-row-checkout mp-pt-10">
								...
								<div id="installments-div" class="mp-col-md-12">
									...
									<?php else : ?>
										<label for="mp-installments" class="mp-label-form"><?= __('Selecione o número da prestação', 'woocommerce-mercadopago') ?></label>
									<?php endif; ?>
					...
					<div id="mp-doc-div" class="mp-col-md-12 mp-doc">
						<div class="frame-tarjetas">
							<!-- Title document -->
							<p class="mp-subtitle-custom-checkout"><?= __('Digite o número do seu documento', 'woocommerce-mercadopago') ?></p>
							...
							<div id="mp-doc-type-div" class="mp-row-checkout mp-pt-10">
								...
								<div id="mp-doc-number-div" class="mp-col-md-8">
									<label for="docNumber" class="mp-label-form"><?= esc_html__('Número do documento', 'woocommerce-mercadopago'); ?> <em>*</em></label>
									<input type="text" class="mp-form-control mp-mt-04rem" id="docNumber" data-checkout="docNumber" autocomplete="off" />
									<p class="mp-desc mp-mt-5 mp-mb-0" data-main="#mp-security-code"><?= esc_html__('Apenas números', 'woocommerce-mercadopago'); ?></p>
									<span class="mp-error mp-mt-5" id="mp-error-324" data-main="#docNumber"><?= esc_html__('Número de Documento Inválido', 'woocommerce-mercadopago'); ?></span>
									<span class="mp-error mp-mt-5" id="mp-error-E301" data-main="#docNumber"><?= esc_html__('Número de Documento Inválido', 'woocommerce-mercadopago'); ?></span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="frame-tarjetas">
							<div class="mp-row-checkout">
								<p class="mp-obrigatory">
									<em>*</em> <?= esc_html__('Campo obrigatório', 'woocommerce-mercadopago'); ?>
								</p>
							</div>
						</div>
					</div>
