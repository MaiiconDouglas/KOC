...
class CartAddItem extends AbstractCartRoute {
	...
	public function get_args() {
		return [
			[
				...
				'args'                => [
					'id'        => [
						'description' => __( 'O produto ou variação do item do carrinho ID.', 'woocommerce' ),
						'type'        => 'integer',
						'context'     => [ 'view', 'edit' ],
						'arg_options' => [
					...
					'quantity'  => [
						'description' => __( 'Quantidade deste item no carrinho.', 'woocommerce' ),
						'type'        => 'integer',
						'context'     => [ 'view', 'edit' ],
						'arg_options' => [
	...
	protected function get_route_post_response( \WP_REST_Request $request ) {
		...
		if ( ! empty( $request['key'] ) ) {
			throw new RouteException( 'woocommerce_rest_cart_item_exists', __( 'Não é possível criar um item de carrinho existente.', 'woocommerce' ), 400 );
		}
