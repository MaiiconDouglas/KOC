...
trait Helper {
    ...
    public function instafeed_render_items() {
        ...
        if (get_transient($key) === false) {
            ...
            $instagram_data = wp_remote_retrieve_body(wp_remote_get('https://api.instagram.com/v1/users/self/media/recent/?access_token=' . $settings['eael_instafeed_access_token'],$request_args));
